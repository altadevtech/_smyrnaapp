...
const Menus = () => {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      toast.error(error.response?.data?.error || 'Erro ao excluir menu. Verifique se não há submenus vinculados.')
      ...
      <div className="card">
        ...
        {menus.length === 0 ? (
          <div className="empty-state">
            <p>Nenhum menu cadastrado. Clique em "Novo Menu" para começar.</p>
          </div>
        ) : (
